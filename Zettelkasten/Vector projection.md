The vector projection of a *vector $\displaystyle \large a$* on a *vector $\displaystyle \large b$*, is the size of the component of $\displaystyle \large a$ on $\displaystyle \large b$.
