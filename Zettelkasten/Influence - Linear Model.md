...
We have to understand if is an *outlier because of misspecification of the model* (not because there is something wrong with the data).

Points that are *highly infruential* they *bring the [[Regression Analysis|Linear Model]] close to them*, so you cannot rely on residuals.
